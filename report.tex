...
\begin{itemize}
 ...
 \item \textbf
  ...
  \item \textbf{Exact duplicate detection: } Whenever two pages have identical \textit{SimHash} fingerprint, we verify if their textual content is identical. Only in such case do we consider these as identical, because two slightly different pages might be assigned the same fingerprint.
